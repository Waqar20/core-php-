...
<html class=" js no-touch no-mobile no-phone no-tablet mobilegradea" style="">
          ...
          <div class="vd_content-section clearfix">
            <div class="panel widget light-widget">
              ...
              <div class="panel-body">
                <h2 class="mgbt-xs-20">ADD USER FORM</h2>
<form class="form-horizontal" action="process/add_user.php" method="post" id="register-form1" novalidate="novalidate" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="company-input-wrapper" class="controls col-sm-6">
                        <input type="text" placeholder="Enter name"  class="width-60 required" required="" name="name" id="company">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="website-input-wrapper" class="controls col-sm-6">
                        <input type="text" placeholder="Enter email"  class="width-60"  name="email" id="website">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="email-input-wrapper" class="controls col-sm-6">
                        <input type="email" placeholder="Enter Password"  class="width-60 required"  required="" name="password" id="" >
                      </div>
                    </div>
                  </div>
 <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="password-input-wrapper" class="controls col-sm-6">
                        <input type="text" placeholder="Enter Number"  class="width-60 required" required=""  name="contact" id="user_mobile_number">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6 mgbt-xs-10 mgtp-20">
                      ...
                      <div class="mgtp-10">
                        <button class="btn vd_bg-green vd_white" name="add" type="submit" id="submit-register" >ADD USER</button>
                      </div>
                    </div>
