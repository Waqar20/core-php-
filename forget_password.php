...
<div class="logo"><h2 class="mgbt-xs-5"><h1 class="mgbt-xs-5" style="color: green;">WEDDING PLANET</h1></h2></div>
...
<form class="form-horizontal" id="forget-password-form1" action="process/forget_password.php" method="post">
...
<span class="vd_alert-icon"><i class="fa fa-exclamation-circle vd_red"></i></span><strong>Oh snap!</strong> <?php echo $_SESSION['message']; ?> </div>

<?php } else if ($_SESSION['status'] == 1) { ?>

<div class="alert alert-success">
<button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
<span class="vd_alert-icon"><i class="fa fa-check-circle vd_green"></i></span><strong>Success!</strong> <?php echo $_SESSION['message']; ?>
</div>
...
<div class="col-md-12">
<p class="text-center"><strong>To reset your password, enter the email address you use to sign in to PLANET.</strong> </p>
<div class="vd_input-wrapper" id="email-input-wrapper">
<span class="menu-icon">
<i class="fa fa-envelope"></i>
</span>
<input type="email" placeholder="Email" id="user_email" name="user_email" class="required">
</div>   
...
<button class="btn vd_bg-green vd_white width-100" type="submit" id="submit-password" name="submit-password">SENT ME CODE</button>   
</div>
<div class="col-md-12 text-center mgbt-xs-5">
<input type="text" placeholder="ENTER CODE" name="">
</div>
<div class="col-md-12 text-center mgbt-xs-5">
<input type="text" placeholder="ENTER NEW PASSWORD" name="">
</div>
<div class="col-md-12 text-center mgbt-xs-5">
...
<a href="login.php">LOGIN</a> <span class="mgr-10 mgl-10">|</span>  	
