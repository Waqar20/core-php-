          ...
          <div class="vd_content-section clearfix">
            <div class="panel widget light-widget">
              ...
              <div class="panel-body">
                <h2 class="mgbt-xs-20">PLANET EDIT FORM</h2>
                <form class="form-horizontal" action="process/edit_planet.php?id=<?php echo $id; ?>" method="post" id="register-form1" novalidate="novalidate" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="website-input-wrapper" class="controls col-sm-6">
                        <input type="text"  class="width-60" value="<?php echo $row->persons; ?>" name="persons" id="website">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <input type="email" placeholder="" class="width-60 required" value="<?php echo $row->location; ?>" required="" 
            name="location" id="user_email" >
              ...
              <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="website-input-wrapper" class="controls col-sm-6">
                        <input type="text"  class="width-60" value="<?php echo $row->price; ?>" name="price" id="website">
                      </div>
                    </div>
                  </div>
